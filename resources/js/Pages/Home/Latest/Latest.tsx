                    ...
                    latestPosts.length && latestPosts.map((element : any, index : number)=> {
                        return  <div key={index} className="w-[90%] max-w-2xl bg-white font-[Poppins] py-7 px-9 mb-6 shadow-md rounded-xl">
                                    <div className="flex flex-row items-center justify-between h-[6rem]">
                                        ...
                                        <img src="https://www.svgrepo.com/show/16833/up-arrow.svg" width="180"
                                            height="180" className='w-[30px] cursor-pointer' alt="Up Arrow SVG Vector" title="Up Arrow SVG Vector" />
                                            <p className="text-2xl font-bold font-[Poppins]">30</p>
                                            <img src="https://www.svgrepo.com/show/145159/down-arrow.svg" 
                                            className='w-[30px] cursor-pointer' alt="Down Arrow SVG Vector" title="Down Arrow SVG Vector" />
                                        </div>
                                    </div>
                                    <div>
                                        {element.image_url != null && <img src={`http://127.0.0.1:8000/uploads/images/${element.image_url}`} alt="" className='h-[300px]'/>}
                                    </div>
                                    <p className=" text-gray-400 mt-4"> {element.body.split(" ")[0] + " " + element.body.split(" ")[1]} </p>
