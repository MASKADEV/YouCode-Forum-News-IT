<template lang="">
   <div class="fixed top-0 w-full h-12 shadow-1xl bg-white z-20 flex items-center">
       <div class="container mx-auto flex flex-row items-center justify-between">
            ...
            <nav>
                <ul class="flex flex-row items-center ">
                    ...
                    <li @click="showPost" class="mr-2 text-3xl font-medium hover:cursor-pointer"><ion-icon name="add-circle-outline"></ion-icon></li>
                </ul>
            </nav>
       </div>
   </div>
